...
export default function EditRouteSheet({
  ...
  useEffect(() => {
    reset(defaultValues);
    setDepartureCityQuery(defaultValues?.departureCity?.title ?? "");
    setArrivalCityQuery(defaultValues?.arrivalCity?.title ?? "");
    setPriceDisplay(
      defaultValues?.price ? formatPrice(defaultValues.price) : "",
    );
  }, [defaultValues, reset]);
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 py-6 px-6">
                        ...
                        <div className="relative flex rounded-md shadow-xs">
                          ...
                          <Input
                            ...
                            onBlur={() => {
                              ...
                              setPriceDisplay(
                                isNaN(num) || num === 0 ? "" : formatPrice(num),
                              );
                              field.onBlur();
                            }}
                          />
          ...
          <SheetFooter className="pt-4 pb-0">
            <Button
              type="submit"
              disabled={isSubmitting || updateRoute.isPending}
